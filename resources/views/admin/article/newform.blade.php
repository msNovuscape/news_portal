    ...
    <div class="col-md-12">
        <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form class="form-horizontal" role="form" id="testform" method="POST" action="{{ url('/admin/article/save') }}">
                        {!! csrf_field() !!}
                        <div class="row">
                         <div class="col-md-12">
                             ...
                             <div class="tab-content">
                                 ...
                                 <div class="tab-pane pt-3" id="tab-data">
                                     ...
                                     <div class="form-group row">
                                         ...
                                         <div class="col-md-10">
                                             <input type="text" name="video" value="{{old('video')}}" placeholder="https://www.youtube.com/v=iweuuower" class="form-control {{ $errors->has('video') ? ' is-invalid' : '' }}">
                                     ...
                                     <div class="form-group row">
                                         ...
                                         <div class="col-md-10">
                                             <input type="text" name="audio" value="{{old('audio')}}" placeholder="https://www.podcast.com/v=iweuuower" class="form-control {{ $errors->has('audio') ? ' is-invalid' : '' }}">
