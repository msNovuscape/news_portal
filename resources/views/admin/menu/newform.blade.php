 ...
 <div class="row">
    <div class="col-md-12">
        <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" role="form" id="testform" method="POST" action="{{ url('/admin/menu/save') }}">
                        {!! csrf_field() !!}
                        <div class="row">
                         <div class="col-md-12">
                             ...
                             <div class="tab-content">
                                 ...
                                 <div class="tab-pane pt-3" id="tab-data">
                                     ...
                                     <div class="form-group row">
                                         ...
                                         <div class="col-md-10">
                                             <input type="text" name="path" value="{{ old('path') }}" placeholder="Parent Title" id="path_id" autocomplete="off" class="form-control" />
                                             <input type="hidden" name="parent_id" id="parent_id" value="{{ old('parnet_id') }}" />
                                         </div>
                                     </div>
                                     ...
                                     <div class="form-group row">
                                         ...
                                         <div class="col-md-10">
                                             <input type="text" class="form-control{{ $errors->has('sort_order') ? ' is-invalid' : '' }}" name="sort_order" value="{{ old('sort_order') }}" placeholder="1">
