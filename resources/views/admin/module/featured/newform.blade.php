...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <form class="form-horizontal" role="form" id="testform" method="POST" action="{{ url('/admin/module/save') }}">
                <div class="card-body">
                                         ...
                                         @foreach($datas['language'] as $language)
                                             <div class="tab-pane pt-3 {{$language['active']}}" id="tab-title{{$language['id']}}">
                                                <div class="form-group row">
                                                    <label class="col-md-3 control-label">Module Title</label>
                                                    <div class="col-md-9">
                                                        <input type="text" required name="description[{{$language['id']}}][title]" value="{{ old('description.'.$language['id'].'.title')}}" placeholder="Module Title" class="form-control" />
                                                    </div>
                                                </div>
                                             </div>
                                         @endforeach
                            ...
                            <div class="row">
                                <div class="col-md-6 box">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="featured_news" placeholder="Select Article" autocomplete="off" >
                                        <input type="hidden" name="featured_news" id="fid">
                                    </div>
                                </div>
                                <div class="col-md-6 box">
                                    <div class="form-group">
                                    ...
                                    <div class="well" id="article_menu" style="height: 150px; overflow: auto; background: #CCC;"></div>
                                </div>
                            </div>
                        </div>
