...
@section('breadcrubm')
    ...
    <li class="breadcrumb-item"><a href="{{ url('/admin/language') }}">Advertise</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" role="form" id="testform" method="POST" action="{{ url('/admin/advertise/update') }}">
                        <input type="hidden" name="id" value="{{$datas['advertise']->id}}">
                        {!! csrf_field() !!}
                        <div class="row">
                            <div class="col-md-10">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" class="form-control{{ $errors->has('href') ? ' is-invalid' : '' }}" name="code" value="{{ $datas['advertise']->href }}" placeholder="https://www.rollingplans.com.np">
                                    ...
                                    <div class="col-md-10">
                                        <select name="status" id="status" class="form-control {{ $errors->has('status') ? ' is-invalid' : '' }}" >
                                            @foreach($datas['status'] as $status)
                                                @if($status['value'] == $datas['advertise']->status)
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <input type="hidden" name="image" value="{{$datas['advertise']->image}}" id="input-image" />
